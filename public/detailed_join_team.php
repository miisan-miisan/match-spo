...
<div class="container" style="text-align: center;">
  ...
  <button class="buttonUnifiedSize" style="margin-right: 50px"><a href="./join_team_mypage.php">戻る</a></button>

  <button class="buttonUnifiedSize" style="margin-left: 50px; background-color: red;" ><a href = "./cancel_joined_team_conf.php?id=<?php echo h($id);?>&teamName=<?php echo $teamName;?>">キャンセル</a></button>
